...
/**
 * Meal — maps directly to TheMealDB API response fields.
 *
 * This is NOT a JPA entity (meals live in the external API).
 * It is a pure DTO used for JSON deserialization / serialization.
 *
 * TheMealDB returns up to 20 ingredient + measure slots.
 * We map them individually so callers can iterate i=1..20.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
@JsonIgnoreProperties(ignoreUnknown = true)   // ignore any extra API fields
public class Meal {
    ...
    /**
     * Utility: count non-blank ingredients for "least ingredients" logic.
     */
